...
-(MJRefreshAutoGifFooter *)mjRefreshAutoGifFooter{
    ...
    if (!mjRefreshAutoGifFooter) {
        ...
        /** 普通闲置状态 */
        [mjRefreshAutoGifFooter setImages:@[KBuddleIMG(@"⚽️PicResource", @"刷新", nil,@"header.png")]
                                 forState:MJRefreshStateIdle];
        [mjRefreshAutoGifFooter setTitle:@"Click or drag up to refresh"
                                forState:MJRefreshStateIdle];
        
        /** 松开就可以进行刷新的状态 */
        [mjRefreshAutoGifFooter setImages:@[KBuddleIMG(@"⚽️PicResource", @"刷新", nil, @"Indeterminate Spinner - Small.png")]
                                 forState:MJRefreshStatePulling];
